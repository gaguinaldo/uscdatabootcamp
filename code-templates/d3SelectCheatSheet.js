// Select the h1 and click through some of the object properties. This is a d3 representation of the element
d3.select("h1")
...
// Select the link tag with a tag inside. Show the a tag is in the object.
d3.select(".link")

// Show the html for the link div
d3.select(".link").html()

// Show how to search within the link div
d3.select(".link>a").text()

// Show how to pull out an attribute
d3.select(".link>a").attr("href")

// Show how to change an attribute and use chaining to change the text
d3.select(".link>a").attr("href", "https://d3js.org/").text("d3js.org")

// Show how to use chained searches for nested elements
